...
2.  **Identify Ambiguities:** Look for missing technical details using references/questions.md.
3.  **Ask Targeted Questions:** Present a concise list of 3-5 high-impact questions to the user.
4.  **Draft a PRD:** Once questions are answered, synthesize the information into a "Mini-PRD" using templates/mini-prd.md.

## Resources
- **references/questions.md**: Domain-specific question bank.
- **templates/mini-prd.md**: Standardized PRD format for the team.
